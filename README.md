...
The executable `minidb` will be created in the `build` directory.
...
For a detailed overview of the system architecture and modules, see [docs/design-implementation.md](docs/design-implementation.md).

## Test Runs
For examples of SQL queries and expected output, see [docs/test-run.md](docs/test-run.md).
